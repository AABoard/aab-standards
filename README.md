...
- Standards drafts and working papers.
- Grade-band AI literacy progressions.
- Clause rationale and evidence mapping.
- Public comments and response-to-comments tables.
- Terminology and taxonomy decisions.
- Versioned releases of approved or consultation-ready standards.
- Templates for standards drafts and review responses.
...
- `docs/` - process guidance for contributors and reviewers.
...
- Keep grade-band developmental progression explicit.
- Separate evidence summaries from normative requirements.
- Preserve uncertainty and limitations.
- Avoid product endorsement through standards language.
- Require source trace for public claims.
- Treat registry records as evidence infrastructure, not automatic AAB positions.

## Contributing

Use `CONTRIBUTING.md` and the standards comment issue template. For major revisions, include the affected clause, proposed language, rationale, evidence sources, and the likely impact on existing drafts.
